...
export default function Home() {
  return (
    <div className="flex flex-col animate-fade-up"> {/* Added fade-up animation */}
      ...
      <section className="flex flex-col md:flex-row gap-12 items-center md:items-start mb-24 pt-12 md:pt-20">
        ...
        <div className="w-full md:w-3/5 order-2 md:order-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/contact"
              className="px-8 py-3 bg-navy text-white font-semibold rounded-sm hover:bg-navy-light transition-colors text-center shadow-sm"
            >
              Contact Office
            </Link>
            <Link
              href="/services"
              className="px-8 py-3 bg-transparent border border-navy text-navy font-semibold rounded-sm hover:bg-navy hover:text-white transition-colors text-center"
            >
              Our Services
            </Link>
          </div>
        ...
        <div className="w-full md:w-2/5 shrink-0 order-1 md:order-2">
          <div className="relative aspect-[4/5] bg-stone/20 overflow-hidden border border-border/50 rounded-sm shadow-md">
            <Image
      ...
      <section className="border-t border-border pt-12 mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-navy mb-2">Stanford University</h3>
            <p className="text-sm text-charcoal">Geriatric Psychiatry Fellowship</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-navy mb-2">Duke University</h3>
            <p className="text-sm text-charcoal">Visiting Fellowship (TMS)</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-navy mb-2">Emory University</h3>
            <p className="text-sm text-charcoal">Visiting Fellowship (ECT)</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-navy mb-2">ABPN Certified</h3>
